...
Проанализируй дату рождения, имя, используй книгу по нумерологии из базы знаний. Подготовь краткий отчёт на 5-7 страниц с основными характеристиками личности, кармическими задачами и рекомендациями.

ВАЖНО: Отчёт должен быть отформатирован в Markdown. Используй заголовки (# ## ###), списки, жирный шрифт (**текст**), курсив (*текст*) для структурирования текста."""
...
Проанализируй дату рождения, имя, используй книгу по нумерологии из базы знаний. Подготовь краткий отчёт на 5-7 страниц в мистическом стиле - кто он по судьбе, его духовная задача, предупреждения.
...
Проанализируй дату рождения, имя, город рождения, время рождения. Используй всю книгу по нумерологии из базы знаний - все методы расчёта, все таблицы, все значения. Подготовь детальный отчёт на 15-20 страниц с полным разбором личности, кармы, предназначения, совместимости, здоровья, карьеры.
...
Проанализируй дату рождения, имя, город рождения, время рождения. Используй всю книгу по нумерологии из базы знаний - все методы, все тайные знания. Подготовь мистическое пророчество на 15-20 страниц - кто он по душе, его прошлые жизни, кармические уроки, духовный путь, предупреждения судьбы.
...
Проанализируй обе даты рождения, имена, используй книгу по нумерологии из базы знаний. Подготовь детальный отчёт на 15-25 страниц о совместимости пары - их сильные стороны, слабые места, как строить отношения, рекомендации для гармонии.
...
Проанализируй обе даты рождения, имена, используй книгу по нумерологии из базы знаний. Подготовь мистическое откровение на 15-25 страниц о судьбе их союза - кармические связи, уроки отношений, духовное предназначение пары, предупреждения.
...
Проанализируй даты рождения всех членов семьи, имена, используй книгу по нумерологии из базы знаний. Подготовь детальный отчёт на 30-50 страниц о семейной совместимости - роли каждого, взаимодействия, конфликты и решения, рекомендации для гармонии в семье.
...
Проанализируй даты рождения всех членов семьи, имена, используй книгу по нумерологии из базы знаний. Подготовь мистическое откровение на 30-50 страниц о родовой карме - кармические связи семьи, духовные задачи рода, предупреждения для каждого члена семьи.
